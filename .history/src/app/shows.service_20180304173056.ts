...
const artists: Show[] = [
  {_id: 1, artist: 'Rex', title: 'The best show is town', description: 'intimate evenning in a unique spot in the city', eventType: ['Public', 'house'], description: "Awesome!", socialMedia: ['FB','Twitter','Instagram'], linktosongs: ['url soundcloud', 'url youtube']},
